...
setup(
    ...
    description="A collection of functions for various purposes",
    ...
    # This field is OPTIONAL
    url="https://github.com/LukasLeindals/llutils",

    # The author name and email fields are self explanatory.
    # These fields are OPTIONAL
    author_name="LukasLeindals",
    author_email="luke.leindance@gmail.com",
